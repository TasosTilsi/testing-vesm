...
public class TC_VESM_UI_008_MakeJumpSearch extends BaseTest {

    @Test
    public void TC_VESM_UI_008_MakeJumpSearch() {

        makeASearch("jump");

        Assert.assertTrue(isElementPresent(By.xpath("//h6[contains(.,'Number of Checks')]")));
        Assert.assertTrue(driver.findElement(By.id("search_title")).getText().equalsIgnoreCase("Jump Search"));
